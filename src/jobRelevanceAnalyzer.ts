...
async function getJobPreferences(): Promise<JobPreferences> {
    try {
 ...
 */
export async function analyzeJobTitleRelevance(jobTitle: string): Promise<AIRelevanceResponse> {
    try {
...
//         const relevance = await analyzeJobTitleRelevance(jobTitleToTest);
...
//         const relevance2 = await analyzeJobTitleRelevance(anotherJobTitle);
//         console.log("Relevance Analysis:");
