...
export default function RejectedJobsPage() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ['jobs', JobStatus.REJECTED, page, limit],
    queryFn: () => jobsClient.getJobs(JobStatus.REJECTED, page, limit),
  });
  ...
  return (
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Rejected Job Listings</CardTitle>
          <CardDescription>
            Jobs that have been verified and rejected.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
