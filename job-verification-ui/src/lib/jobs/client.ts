import { jobsApi as realJobsApi, Job, JobStatus, PaginatedResponse, CreateManualJobRequest } from './api';
...
export type { Job, PaginatedResponse, CreateManualJobRequest }; // Keep these as type-only exports